...
v-boot is a lightweight, custom-engineered secondary bootloader designed to provide native Fastboot, Recovery and Kernel booting capabilities on ARM32 and ARM64 mobile platforms.
---
...
🚀 Key Features
    ...
    Zero Payload Overhead: No U-BOOT/EDK2 bloat. The logic is native, lightweight, and tightly integrated for maximum performance.
